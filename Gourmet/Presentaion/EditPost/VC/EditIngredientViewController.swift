...
protocol EditIngredientViewDelegate: AnyObject {
...
final class EditIngredientViewController: UIViewController {
    ...
    weak var delegate: EditIngredientViewDelegate?
    private let disposeBag = DisposeBag()
    
    init(ingredient: RecipeIngredient) {
        
        self.ingredient = ingredient.isAddCell ? RecipeIngredient(name: "", value: "") : ingredient
...
// MARK: - Configuration
extension EditIngredientViewController: BaseViewProtocol {
